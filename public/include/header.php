    ...
    <header class="p-3 mb-3 border-bottom">
        <div class="container">
            <div class="d-flex flex-wrap align-items-center justify-content-between">
                <a href="/TKHTPM_BanHang/index.php" class="logo">NKT</a>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu text-small shadow" aria-labelledby="accountDropdown">
                            <?php if (!empty($_SESSION['name'])): ?>
                                <li><a class="dropdown-item" href="/TKHTPM_BanHang/public/pages/logout.php">Đăng Xuất</a></li>
                                <li><a class="dropdown-item" href="/TKHTPM_BanHang/public/pages/account.php">Quản lí tài khoản</a></li>
                            <?php else: ?>
                                <li><a class="dropdown-item" href="/TKHTPM_BanHang/public/pages/login.php">Đăng Nhập</a></li>
                                <li><a class="dropdown-item" href="/TKHTPM_BanHang/public/pages/register.php">Đăng Ký</a></li>
                            <?php endif; ?>
                        </ul>
                    </li>
                </ul>
