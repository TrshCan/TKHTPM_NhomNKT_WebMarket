...
<body>
    ...
    <header>
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                <a class="navbar-brand fw-bold" href="<?= $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['HTTP_HOST']; ?>/TKHTPM_NhomNKT_WebMarket.git/index.php" style="font-family: 'Arial', sans-serif;">Trang Chủ</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item">
                            <a class="nav-link text-white fw-bold" href="<?= $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['HTTP_HOST']; ?>/TKHTPM_NhomNKT_WebMarket.git/public/pages/cart.php" style="font-family: 'Arial', sans-serif;">Giỏ Hàng</a>
                        </li>
