...
<body>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto"> <!-- Menu nằm bên phải -->
                <li class="nav-item">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="accountDropdown">
                        <li><a class="dropdown-item" href="login.php" style="font-family: 'Arial', sans-serif;">Đăng Nhập</a></li>
                        <li><a class="dropdown-item" href="register.php" style="font-family: 'Arial', sans-serif;">Đăng Ký</a></li>
                    </ul>
                </li>
            </ul>
        </div>
